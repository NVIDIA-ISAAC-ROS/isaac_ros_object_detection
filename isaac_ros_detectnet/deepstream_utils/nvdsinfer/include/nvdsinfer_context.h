...
#include "deepstream_utils/nvdsinfer/include/nvdsinfer.h"
...
/**
 * Fixed array bounds for @ref NvDsInferContextInitParams (cpplint/runtime/arrays
 * requires enumerator names, not macro-only bounds).
 */
enum NvDsInferContextArrayBounds
{
  kNvDsInferContextPathMax = 4096,
  kNvDsInferContextMaxStrLength = 1024,
  kNvDsInferContextMaxChannels = 4
};

/** Maximum length of a file path parameter. */
#define _PATH_MAX kNvDsInferContextPathMax

/** Defines the maximum number of channels supported by the API
for image input layers. */
#define _MAX_CHANNELS kNvDsInferContextMaxChannels

/** Defines the maximum length of string parameters. */
#define _MAX_STR_LENGTH kNvDsInferContextMaxStrLength
...
typedef enum
{
  ...
  NvDsInferUffOrder_kNCHW _DS_DEPRECATED_("Use NvDsInferTensorOrder_kNCHW instead") =
  NvDsInferTensorOrder_kNCHW,
  NvDsInferUffOrder_kNHWC _DS_DEPRECATED_("Use NvDsInferTensorOrder_kNCWH instead") =
  NvDsInferTensorOrder_kNHWC,
  NvDsInferUffOrder_kNC _DS_DEPRECATED_("Use NvDsInferTensorOrder_kNC instead") =
    NvDsInferTensorOrder_kNC
...
typedef struct _NvDsInferContextInitParams
{
  ...
  char protoFilePath[kNvDsInferContextPathMax];
  /** Holds the pathname of the caffemodel file. */
  char modelFilePath[kNvDsInferContextPathMax];
  /** Holds the pathname of the UFF model file. */
  char uffFilePath[kNvDsInferContextPathMax];
  /** Holds the pathname of the ONNX model file. */
  char onnxFilePath[kNvDsInferContextPathMax];
  /** Holds the pathname of the TLT encoded model file. */
  char tltEncodedModelFilePath[kNvDsInferContextPathMax];

  /** Holds the pathname of the INT8 calibration file.
  Required only when using INT8 mode. */
  char int8CalibrationFilePath[kNvDsInferContextPathMax];
  ...
  char uffInputBlobName[kNvDsInferContextMaxStrLength];
  ...
  char tltModelKey[kNvDsInferContextMaxStrLength];
  ...
  char modelEngineFilePath[kNvDsInferContextPathMax];
  ...
  float offsets[kNvDsInferContextMaxChannels];
  ...
  char customLibPath[kNvDsInferContextPathMax];
  /** Holds the name of the custom bounding box function
  in the custom library. */
  char customBBoxParseFuncName[kNvDsInferContextMaxStrLength];
  /** Name of the custom classifier attribute parsing function in the custom
  *  library. */
  char customClassifierParseFuncName[kNvDsInferContextMaxStrLength];
  ...
  char customNetworkConfigFilePath[kNvDsInferContextPathMax];

  /** Name of the custom engine creation function in the custom library. */
  char customEngineCreateFuncName[kNvDsInferContextMaxStrLength];
  ...
  */
  ...
  in the custom library. */
  char customBBoxInstanceMaskParseFuncName[kNvDsInferContextMaxStrLength];
 ...
 */
typedef void (*NvDsInferContextLoggingFunc)(
 ...
 */
NvDsInferStatus createNvDsInferContext(
  NvDsInferContextHandle * handle,
 ...
 *  otherwise.
 */
NvDsInferStatus NvDsInferContext_Create(
  NvDsInferContextHandle *handle,
 ...
 *  an error status otherwise.
 */
NvDsInferStatus NvDsInferContext_QueueInputBatch(
  NvDsInferContextHandle handle,
 ...
 *  otherwise.
 */
NvDsInferStatus NvDsInferContext_DequeueOutputBatch(
  NvDsInferContextHandle handle,
 ...
 */
void NvDsInferContext_ReleaseBatchOutput(
  NvDsInferContextHandle handle,
  NvDsInferContextBatchOutput *batchOutput);
 ...
 */
void NvDsInferContext_GetNetworkInfo(
  NvDsInferContextHandle handle,
 ...
 */
unsigned int NvDsInferContext_GetNumLayersInfo(
  NvDsInferContextHandle handle);
 ...
 * @param[in,out] layersInfo    A pointer to an array of NvDsInferLayerInfo
                structures to be filled by the function.
 */
void NvDsInferContext_FillLayersInfo(
  NvDsInferContextHandle handle,
 ...
 */
const char * NvDsInferContext_GetLabel(
  NvDsInferContextHandle handle,
