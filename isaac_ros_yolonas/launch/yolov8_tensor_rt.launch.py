...
def generate_launch_description():
    ...
    yolonas_decoder_node = ComposableNode(
        name='yolonas_decoder_node',
        package='isaac_ros_yolonas',
        plugin='nvidia::isaac_ros::yolonas::YoloNasDecoderNode',
        parameters=[{
    ...
    tensor_rt_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[encoder_node, tensor_rt_node, yolonas_decoder_node],
        output='screen',
